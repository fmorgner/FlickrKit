...
@implementation FKAuthorizationSheetController
...
+ (FKAuthorizationSheetController*)authorizationSheetControllerWithURL:(NSURL*)anAuthorizationURL
	{
	return [[FKAuthorizationSheetController alloc]initWithWindowNibName:@"FKAuthorizationSheetController" authURL:anAuthorizationURL];
	}
...
- (void)sheetDidEnd:(NSWindow *)sheet returnCode:(NSInteger)returnCode contextInfo:(void *)contextInfo
	{
	[[NSNotificationCenter defaultCenter] postNotificationName:FKNotificationAuthorizationSheetDidClose object:self];
	[sheet orderOut:self];
	}
